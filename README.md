...
## TODOs
- [ ] Push code to GitHub.
- [ ] Organize the code, try to keep the model training and the analyzing code separate.
...
- If A=1, B=0.0001, during training, initial (A mse, B fr) = (0.18, 0.03), end of training (A mse, B fr) = (0.02, 0.003). Sequential firing is observed. 
![sequential firing of 1:0.0001](image-1.png)

- If A=1, B=1, during training, initial (A mse, B fr) = (0.19, 288), end of training (A mse, B fr) = (0.10, 0.08). It doesn't learn with 5000 epochs. 
