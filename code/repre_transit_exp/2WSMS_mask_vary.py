...
# trial.                            X.    Y.    #
# 0:      0-0.5,      0.5-0.1       0     0     #
# 1:      0.05-0.45,  0.55-0.95     5     5     $
# 2:      0.1-0.4,    0.6-0.9       10    10    #
# 3:      0.15-0.35,  0.65-0.85     15    15    #
# 4:      0.2-0.3,    0.7-0.8       20    20    #
# 5:      0.25-0.3,   0.75-0.8      25    25    #
# --------------------------------------------- #

# CHange X, Y to vary the masking ratio
trial, X, Y = 0, 0, 0
...
load_data_type = f'2WSMS_mask_vary{trial}'
